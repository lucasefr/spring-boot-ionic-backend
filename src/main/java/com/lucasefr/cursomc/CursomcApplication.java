...
import com.lucasefr.cursomc.domain.ItemPedido;
import com.lucasefr.cursomc.domain.Pagamento;
import com.lucasefr.cursomc.domain.PagamentoComBoleto;
import com.lucasefr.cursomc.domain.PagamentoComCartao;
import com.lucasefr.cursomc.domain.Pedido;
import com.lucasefr.cursomc.domain.Produto;
...
import com.lucasefr.cursomc.repositories.EstadoRepository;
import com.lucasefr.cursomc.repositories.ItemPedidoRepository;
import com.lucasefr.cursomc.repositories.PagamentoRepository;
import com.lucasefr.cursomc.repositories.PedidoRepository;
import com.lucasefr.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "363737737", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("812398912", "9863216"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "645465454", cli1, c2);
